...
const Feature = () => {
  ...
  return (
    <section className="container pb-[150px] mt-20">
      <div className="relative z-10 mx-auto mt-0 mb-12 max-w-[475px] text-center">
        {/* <p className="section-tagline">Our Team</p> */}
        <h2>Is your project suffering from the following problems?</h2>
      </div>
