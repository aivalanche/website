              ...
              <form onSubmit={handleWaitlistSubmit} className="mx-auto mt-8 max-w-xl">
                <div className="flex flex-col gap-3 sm:flex-row">
                  <input
                    ...
                    required
                    disabled={submitting}
                    className="flex-1 rounded-xl border border-borderColor bg-white/90 px-5 py-3.5 text-paragraph transition-all placeholder:text-paragraph-light/50 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-borderColor-dark dark:bg-dark-100/90 dark:text-white dark:placeholder:text-white/40"
                  />
                  <button
                    type="submit"
                    disabled={submitting}
                    className={`flex items-center justify-center gap-2 whitespace-nowrap rounded-xl px-7 py-3.5 font-semibold transition-all duration-300 ${
                      submitting
                        ? 'bg-primary/55'
