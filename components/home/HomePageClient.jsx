...
import {
    ArrowRight, CaretDown, CheckCircle,
    Lightning, Plugs,
    ChartBar, UsersThree, Code, Handshake,
    ChatCircleDots, Brain, Checks, TerminalWindow, ChartLineUp, CurrencyCircleDollar
...
const integrationCategories = {
    de: [
        ...
        { title: 'Entwicklung', description: 'Für Ihr Engineering-Team.', items: ['GitHub', 'GitLab', 'Bitbucket', 'VS Code', 'Vercel', 'AWS', 'Docker', 'Sentry', 'Datadog', 'PagerDuty'] },
    ...
    en: [
        ...
        { title: 'CRM & Sales', description: 'Your sales pipeline under control.', items: ['Salesforce', 'HubSpot', 'Pipedrive', 'Zoho CRM', 'Close.io', 'Freshsales'] },
        { title: 'Development', description: 'For your engineering team.', items: ['GitHub', 'GitLab', 'Bitbucket', 'VS Code', 'Vercel', 'AWS', 'Docker', 'Sentry', 'Datadog', 'PagerDuty'] },
...
const integrationSectionCopy = {
    de: {
        ...
        flowDescription: 'Sie senden eine Aufgabe im Chat. Der Agent orchestriert APIs, Daten und Automationen und liefert den Status transparent zurück.',
        ...
        openclawDescription: 'OpenClaw verbindet AIvalanche mit Ihren Chat-Kanälen und bringt Aufgaben ohne Toolwechsel in die Ausführung.',
    },
    en: {
        badge: 'INTEGRATIONS',
        titlePrefix: '3,000+ ',
        ...
        flowDescription: 'Your team posts a task in chat. The agent orchestrates APIs, data, and automations, then returns clear status and next actions.',
        ...
        lessLabel: 'less',
        openclawBadge: 'Powered by OpenClaw',
        openclawDescription: 'OpenClaw connects AIvalanche across your chat channels so work moves from request to execution without tool switching.',
    },
}

const useCaseCardMeta = [
    { surface: 'bg-gradient-to-br from-orange-50 to-white dark:from-orange-500/10 dark:to-dark-200', iconTone: 'bg-orange-100 text-orange-700 dark:bg-orange-500/20 dark:text-orange-300' },
    { surface: 'bg-gradient-to-br from-cyan-50 to-white dark:from-cyan-500/10 dark:to-dark-200', iconTone: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-500/20 dark:text-cyan-300' },
    { surface: 'bg-gradient-to-br from-lime-50 to-white dark:from-lime-500/10 dark:to-dark-200', iconTone: 'bg-lime-100 text-lime-700 dark:bg-lime-500/20 dark:text-lime-300' },
]
...
const featureSectionCopy = {
    de: {
        ...
        competencySignals: [
            'Nachvollziehbare Tool-Aktionen',
            'Freigaben bei Risiko',
            'Kontext über Sessions',
        ],
        ...
        detailsByIcon: {
            ...
            zap: {
                summary: 'Entscheidungslogik bewertet Signale aus Ihren Systemen und schlaegt den naechsten besten Schritt vor.',
                points: [
                    ...
                    <FadeUpAnimation className="container">
                        <div className="relative z-10 text-center">
                            ...
                            <div className="mx-auto mb-12 flex items-center justify-center">
                                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-paragraph/5 dark:bg-white/10 border border-borderColor dark:border-borderColor-dark text-sm text-paragraph-light dark:text-white/70">
                            ...
                            <div className="mx-auto flex flex-col items-center justify-center gap-4 md:flex-row">
                                ...
                                <a href="#features" className="px-7 py-3.5 rounded-full border-2 border-paragraph/20 dark:border-white/20 text-paragraph dark:text-white hover:border-primary hover:bg-primary/10 hover:text-primary transition-all duration-300 flex items-center font-medium">
                                    ...
                                    <CaretDown className="ml-2 w-4 h-4" weight="bold" />
                                </a>
                            </div>
                        ...
                        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                            {t.features.items.map((feature, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`pointer-events-none absolute -right-10 -top-8 h-32 w-32 rounded-full bg-gradient-to-br ${cardMeta.glow} opacity-70 blur-2xl transition-opacity duration-300 group-hover:opacity-100`} />
                                        <div className="relative mb-5 flex items-start justify-between">
                                            ...
                                            <span className={`flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br ${cardMeta.iconTone} text-white shadow-md shadow-black/10`}>
                                                <Icon className="h-5 w-5" />
                                            </span>
                                        </div>
                                        <h3 className="relative mb-2 text-lg font-semibold text-paragraph dark:text-white">{feature.title}</h3>
                                        <p className="relative text-sm leading-relaxed text-paragraph-light dark:text-white/70">{feature.description}</p>
                                        ...
                                        <div
                                            ...
                                            className={`absolute inset-0 z-20 rounded-3xl border border-primary/35 bg-white/95 p-5 backdrop-blur-xl transition-all duration-300 dark:bg-dark-200/95 ${isActive ? 'translate-y-0 opacity-100' : 'pointer-events-none translate-y-2 opacity-0'
                                                }`}
                                        >
                        ...
                        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)]">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="mt-8 grid gap-3 sm:grid-cols-2">
                                        {primaryUseCase.examples.map((example) => (
                                            <div key={example} className="flex items-center gap-2 rounded-xl border border-borderColor/80 bg-white/75 px-3 py-2 dark:border-borderColor-dark dark:bg-dark-100/70">
                            ...
                            <div className="grid gap-4">
                                {secondaryUseCases.map((useCase, i) => {
                                    ...
                                    return (
                                        <article key={useCase.title} className={`cursor-pointer rounded-2xl border border-borderColor/80 p-6 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_20px_45px_-28px_rgba(15,23,42,0.35)] dark:border-borderColor-dark ${style.surface}`}>
                                            ...
                                            <div className="mt-4 flex flex-wrap gap-2">
                                                {useCase.examples.slice(0, 3).map((example) => (
                                                    <span key={example} className="rounded-full border border-borderColor/80 bg-white/85 px-3 py-1 text-xs font-medium text-paragraph-light dark:border-borderColor-dark dark:bg-dark-100/80 dark:text-white/70">
                                                        {example}
                                                    </span>
                                                ))}
                                            </div>
                            ...
                            <div className="rounded-3xl border border-borderColor/80 bg-white/85 p-5 backdrop-blur-xl dark:border-borderColor-dark dark:bg-dark-200/85">
                                ...
                                <ul className="mt-4 space-y-3">
                                    {integrationStats.map((stat) => (
                                        <li key={stat.label} className="flex items-center justify-between rounded-xl border border-borderColor/80 bg-white/75 px-3 py-2 dark:border-borderColor-dark dark:bg-dark-100/75">
